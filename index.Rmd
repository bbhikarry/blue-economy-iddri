...
>**Keywords**: Digital Transformation, Resilience, Competitiveness, Socio-environmental sustainability, Blue tourism.

#### Local 'Blue Economy' is lacking modern tech framework (*i.e DT*) with data gathering and information dissemination at its core.
...
E[label=' Enables '];
F[label=' Aligns '];
G[label=' Helps partnerships '];

edge 
[color=LightBlue, arrowhead=vee]
{B->C->D->E->F->G->B}->A
}")
