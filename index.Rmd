...
## IDDRI's Tobago pilot in the digital space

<!-- Quantify the scope of the problem and connect it to my audience . Achieve this in this slide by .panelset.sideways[] -->

>**Keywords**: Digital Transformation Leadership, Resilience, Competitiveness, Socio-environmental sustainability, Blue tourism.

#### Local 'Blue' needs to be placed into a modern tech framework (*i.e DTL*) with data gathering and information dissemination at its core.
...
B[label=' Sustain DTL '];
C[label='  Create knowledge  '];
D[label=' Innovate'];
E[label=' Motivate '];
F[label=' Align outward '];
G[label=' Partnerships '];

edge 
[color=blue, arrowhead=vee]
{B->C->D->E->F->G->B}->A
}")
...
## IDDRI's pilot in the marine space
...
Align our pilot project actions to IDDRI's sought for outcome by tackling this threat to tourism and marine ecosystems.
...
## Local lionfish fishery. (Pilot in a pilot)
...
---
## Local lionfishery. Opportunity?
```{r echo=FALSE, fig.height=6, fig.width=8}
DiagrammeR::grViz("digraph
                  {graph [rankdir = LR]
                  
                  # primary nodes
                  node [shape = box, style = filled,fillcolor = Beige, fontname = Helvetica, fontsize = 22, color=Gray]
...
Shades of Adele.....  So. We have looked at two ideas which works with/for each other and fits (as well) into the bigger scheme of IDDRI thinking. Will they do the job? Enter the acid test (next panel). 


```{r echo=FALSE}

<iframe width="560" height="315" src="https://www.youtube.com/embed/rYEDA3JcQqw?controls=0" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
