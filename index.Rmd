...
Energy & Fishery type activities missing. Why is this?
]
...
---
## Protecting 'Blue'
.left-column[![](index_files/figure_html/lionfish.png)]
.right-column[Balance the act by protecting the Blue tourism economy And marine ecological systems:w
]


---

## Framing the IDDRI pilot

>**Keywords**: Resilience, Competitiveness, Socio-environmental sustainability, Tourism.

#### Local B.E. needs to be placed into a modern tech framework with data gathering and information dissemination at its core. 
...
A [shape = folder, fillcolor = Beige, label = 'Is validated with evidence \n and stakeholder consultation']; 


subgraph{rank = same; 
B [label = 'Step 1 \n Addresses Blue Tourism development challenges', fillcolor = Bisque]; 
C [label = 'Step 2 \n  Identifies what is needed for change. \n e.g. Common booking system. \n Blue product showcase and knowledgebase. \n Usage statistics. ', fillcolor = Linen];}

subgraph{rank = same; D [label = 'Step 3 \n Reflect assumptions and risks e.g \n Local providers slow to adopt E-practises. \n Trust in advertising a minus factor. ', fillcolor = LightGoldenrodYellow]; E [label = 'Step 4 \n Identify partners and key actors', fillcolor = LightYellow];}
...
|Outputs|1. Lionfish filets kitchen etc||||
|Activities|1. Prep workshops, dive derbies, pot making ||||  
...
||Description|Indicators|MoV|Risks and Assumptions|
|:---|:---|:---|:---|:---|
|Goal|1. Attract Blue economy tourism clientele||||
||2. Improve responsible seafood selections ||||
|Outcomes|1. Online campaign *to reduce load on other (popular) marine species* ||||
||2. Enable fisher and restaurant feedback. *Obtain a feel for lionfish invasion level*||||
|Outputs|1. Online/Ground lionfish reduction campaign||||
||2. Enable digital feedback mechanism||||
|Activities|1. Central booking system to improve 'blue oriented' customer base ||||  
...
subgraph{rank = same; B [label = 'Step 1 \n Focus',fillcolor = orange]; C [label = 'Step 2 \n  Identify what is needed for change ', fillcolor = yellow];}
