...
DiagrammeR::grViz("digraph
                  ...
                  # primary nodes
                  node [shape = rectangle, fillcolor = WhiteSmoke, fontname = Helvetica, fontsize = 12]
...
C [label = 'Improved level of lionfish consumption in homes etc'];

D [label = 'Improved understanding of marine ecology'];

# Row 3 Col 1

1 [label = 'Reward catchers with cash'];
 
2 [label = 'Lionfish becomes known as prime catch'];
