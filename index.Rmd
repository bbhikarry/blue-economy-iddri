...
author: 
  - "Tobago Hotel and Tourism Assox"
  - "Environment Tobago"
date: '`r Sys.Date()`'
output:
...
.left-column[ **B.E** not showing Conservation or Energy type activities  
...
.right-column[
Tourism is the sector most affected by COVID. Recovery **will** see accelerated tourism. To sustain that growth requires tech.
]
...
#### Largely untapped **or statistically recorded** local B.E. needs to be placed into a modern tech framework. 


![](index_files/figure_html/sd.jpeg)

Objectives: To **service the keywords** and **embed ESG partnership**. 
